...
Write-Host ''
Write-Host '=============================================='
Write-Host '  WFM Bridge - eenmalige installatie'
Write-Host '=============================================='
Write-Host ''
...
if (-not $ahkExe) {
    throw 'AutoHotkey v2 is niet gevonden op deze pc. Installeer eerst AutoHotkey v2 en voer daarna deze WFM Bridge installer opnieuw uit.'
}
